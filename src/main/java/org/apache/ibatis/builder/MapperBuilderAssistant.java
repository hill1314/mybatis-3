...
public class MapperBuilderAssistant extends BaseBuilder {
   ...
   * @param flushCache     刷新缓存
   * @param useCache       使用缓存
   * @param resultOrdered  结果排序
   * @param keyGenerator   Key发电机
   * @param keyProperty    Key所有物
   * @param keyColumn      Key柱
   * @param databaseId     数据库id
   * @param lang           lang
   * @param resultSets     结果集
   * @param dirtySelect    脏选择
